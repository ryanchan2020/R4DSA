...
![](img/28. Use Separate Legends.JPG)
...
![](img/33. Create New Dashboard.JPG)

2. Under the ‘Size’ options, select ‘Automatic’.

![](img/34. Automatic Sizing.JPG)
